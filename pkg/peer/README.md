...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/p9c/node9/peer)
...
```bash
$ go get -u github.com/p9c/node9/peer
```

## Examples

- [New Outbound Peer Example](https://godoc.org/github.com/p9c/node9/peer#example-package--NewOutboundPeer)  
