...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/p9c/node9/rpcclient)
...
- [API Reference](http://godoc.org/github.com/p9c/node9/rpcclient)

- [pod Websockets Example](https://github.com/p9c/node9/tree/master/rpcclient/examples/podwebsockets)
...
- [btcwallet Websockets Example](https://github.com/p9c/node9/tree/master/rpcclient/examples/btcwalletwebsockets)
...
- [Bitcoin Core HTTP POST Example](https://github.com/p9c/node9/tree/master/rpcclient/examples/bitcoincorehttp)
...
```bash
$ go get -u github.com/p9c/node9/rpcclient
```
